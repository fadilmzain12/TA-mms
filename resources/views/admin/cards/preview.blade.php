...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Member ID Card Preview</h1>
    ...
    <div class="col-md-8 mx-auto">
        <div class="card card-admin shadow mb-4">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-primary">Member Card Preview</h6>
                <div>
                    <form action="{{ route('admin.cards.save', $member->id) }}" method="POST">
                        @csrf
                        <button type="submit" class="btn btn-sm btn-success">
                            <i class="bi bi-save me-1"></i> Save & Generate Card
                        </button>
                    </form>
                </div>
            </div>
                        ...
                        <div class="card-content">
                            <div class="id-card-header">
                                ...
                                <div class="id-card-org">
                                    ...
                                    <p class="small mb-0">Kartu Anggota Card</p>
                                </div>
                            </div>
                            
                            <div class="id-card-body">
                                <div class="id-card-photo">
                                    <img src="{{ $photoUrl }}" alt="{{ $member->full_name }}" class="img-fluid rounded">
                                </div>
                                ...
                                <div class="id-card-details">
                                    <table class="table table-sm table-borderless mb-0">
                                        ...
                                        <tr>
                                            <td class="fw-bold field-name">Tanggal Penerbitan Kartu</td>
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <p class="mb-0">{{ $member->registration_number }}</p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
