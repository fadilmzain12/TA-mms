...
@section('title', 'Card Download')

@section('content')
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Member ID Card Download</h1>
    ...
    <div class="col-md-8 mx-auto">
        <div class="card card-admin shadow mb-4">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-primary">Member Card</h6>
                <div class="btn-group">
                    <button onclick="printCard()" class="btn btn-sm btn-primary">
                        <i class="bi bi-printer me-1"></i> Print Card
                    </button>
                    <a href="{{ route('admin.cards.pdf', $member->id) }}" class="btn btn-sm btn-success">
