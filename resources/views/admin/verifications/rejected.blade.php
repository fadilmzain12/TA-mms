...
@section('title', 'Pendaftaran Ditolak - Admin MMS')
...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <div>
            ...
            <p class="text-muted">Anggota yang pendaftarannya ditolak</p>
        </div>
        <div class="btn-toolbar mb-2 mb-md-0">
            <div class="btn-group me-2">
                ...
                <a href="{{ route('admin.verifications.rejected') }}" class="btn btn-sm btn-primary">Ditolak</a>
            </div>
        </div>
    </div>
    ...
    <div class="card card-admin shadow mb-4">
        <div class="card-body">
            <form action="{{ route('admin.verifications.rejected') }}" method="GET">
                <div class="row g-3 align-items-end">
                    ...
                    <div class="col-md-auto">
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('admin.verifications.rejected') }}" class="btn btn-secondary">Reset</a>
                        </div>
                    </div>
                </div>
            </form>
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <p class="text-muted">Menampilkan <span class="fw-medium">{{ $rejectedRegistrations->firstItem() ?? 0 }}</span> - <span class="fw-medium">{{ $rejectedRegistrations->lastItem() ?? 0 }}</span> dari <span class="fw-medium">{{ $rejectedRegistrations->total() }}</span> anggota</p>
        <span class="badge bg-danger rounded-pill">{{ $rejectedRegistrations->total() }} ditolak</span>
    </div>
        ...
        <div class="card-body p-0">
            @if($rejectedRegistrations->isEmpty())
                <div class="p-5 text-center">
                    ...
                    <p class="text-muted mb-0">Belum ada anggota yang ditolak.</p>
                </div>
            @else
    ...
    <!-- Pagination -->
    <div class="mt-4">
        {{ $rejectedRegistrations->links('pagination::bootstrap-5') }}
    </div>
</div>
@endsection